...
"""Gene science module for trait inheritance calculations."""
...
# Traits inherit with 50% probability from each parent
"""Apply genetic traits from parents to offspring."""
...
"""Apply genetic mutation rules to produce offspring traits."""
