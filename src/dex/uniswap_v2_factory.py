...
def all_pairs_length(rpc_address, factoryAddress, abi):
...
def all_pairs(index, rpc_address, factoryAddress, abi):
    '''
...
def get_pair(token_address_1, token_address_2, rpc_address, factoryAddress, abi):
    w3 = Web3(Web3.HTTPProvider(rpc_address))
