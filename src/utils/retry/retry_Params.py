...
def getRetryParams(retryType: str):
    ...
    if isDocker:
        if retryType == "http":
            ...
            return int(os.environ.get("TRANSACTION_QUERY_RETRY_LIMIT")), int(
                os.environ.get("TRANSACTION_QUERY_RETRY_DELAY"))
        elif retryType == "transactionAction":
            return int(os.environ.get("TRANSACTION_ACTION_RETRY_LIMIT")), int(
                os.environ.get("TRANSACTION_ACTION_RETRY_DELAY"))
        else:
