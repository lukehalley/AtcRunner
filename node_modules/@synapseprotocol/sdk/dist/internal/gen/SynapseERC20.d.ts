...
export interface SynapseERC20Interface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "DEFAULT_ADMIN_ROLE" | "DOMAIN_SEPARATOR" | "MINTER_ROLE" | "allowance" | "approve" | "balanceOf" | "burn" | "burnFrom" | "decimals" | "decreaseAllowance" | "getRoleAdmin" | "getRoleMember" | "getRoleMemberCount" | "grantRole" | "hasRole" | "increaseAllowance" | "initialize" | "mint" | "name" | "nonces" | "permit" | "renounceRole" | "revokeRole" | "symbol" | "totalSupply" | "transfer" | "transferFrom"): FunctionFragment;
...
export interface SynapseERC20 extends BaseContract {
    ...
    functions: {
         ...
         */
        initialize(_name: string, _symbol: string, _decimals: BigNumberish, _owner: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
         ...
         * @param _symbol Token symbol
         */
        initialize(_name: string, _symbol: string, _decimals: BigNumberish, _owner: string, overrides?: CallOverrides): Promise<void>;
