...
export interface AvaxJewelMigrationInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "LEGACY_TOKEN" | "NEW_TOKEN" | "SYNAPSE_BRIDGE" | "migrate" | "migrateAndBridge" | "owner" | "redeemLegacy" | "renounceOwnership" | "transferOwnership"): FunctionFragment;
    encodeFunctionData(functionFragment: "LEGACY_TOKEN", values?: undefined): string;
    encodeFunctionData(functionFragment: "NEW_TOKEN", values?: undefined): string;
    encodeFunctionData(functionFragment: "SYNAPSE_BRIDGE", values?: undefined): string;
    encodeFunctionData(functionFragment: "migrate", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "migrateAndBridge", values: [BigNumberish, string, BigNumberish]): string;
    encodeFunctionData(functionFragment: "owner", values?: undefined): string;
    encodeFunctionData(functionFragment: "redeemLegacy", values?: undefined): string;
    encodeFunctionData(functionFragment: "renounceOwnership", values?: undefined): string;
    encodeFunctionData(functionFragment: "transferOwnership", values: [string]): string;
    decodeFunctionResult(functionFragment: "LEGACY_TOKEN", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "NEW_TOKEN", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "SYNAPSE_BRIDGE", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "migrate", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "migrateAndBridge", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "owner", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "redeemLegacy", data: BytesLike): Result;
...
export interface AvaxJewelMigration extends BaseContract {
    ...
    functions: {
        ...
        migrate(amount: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        migrateAndBridge(amount: BigNumberish, to: string, chainId: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        /**
        ...
        redeemLegacy(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        /**
    ...
    callStatic: {
        ...
        migrateAndBridge(amount: BigNumberish, to: string, chainId: BigNumberish, overrides?: CallOverrides): Promise<void>;
        /**
         * Returns the address of the current owner.
         */
        owner(overrides?: CallOverrides): Promise<string>;
