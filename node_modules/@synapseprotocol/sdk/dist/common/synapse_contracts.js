...
(function (SynapseContracts) {
    var _a;
    var SynapseContract = /** @class */ (function () {
        function SynapseContract(_a) {
            var bridge = _a.bridge, _b = _a.bridgeZap, bridgeZap = _b === void 0 ? null : _b;
    ...
    SynapseContracts.DFK = new SynapseContract({
