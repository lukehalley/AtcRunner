...
export declare namespace SwapPools {
    ...
    export const OPTIMISM_POOL_SWAP_TOKEN: SwapToken;
    export const OPTIMISM_ETH_SWAP_TOKEN: ETHSwapToken;
    export const CRONOS_POOL_SWAP_TOKEN: SwapToken;
    ...
    export const HARMONY_AVAX_SWAP_TOKEN: SwapToken;
    export const HARMONY_JEWEL_SWAP_TOKEN: SwapToken;
