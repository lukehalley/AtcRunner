...
import { tokenSwitch } from "../internal/index.js";
...
(function (BridgeUtils) {
    ...
    function makeTokenArgs(chainId, t) {
        let toks = SwapPools.bridgeSwappableMap[chainId].swappableSwapGroups[t.swapType].poolTokens, idx = toks.findIndex((tok) => findSymbol(tok, t));
        return [toks, idx];
    }
