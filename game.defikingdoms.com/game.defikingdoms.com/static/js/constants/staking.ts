import { ChainId, Token } from 'constants/sdk-extra'
...
export const STAKING_REWARDS_INFO: {
  ...
  [ChainId.DFK_MAINNET]: [
    {
      pid: 0,
      tokens: getPairTokensWithDefaults(ChainId.DFK_MAINNET, 'XJEWEL/WJEWEL'),
      active: true
    },
    {
      pid: 1,
      tokens: getPairTokensWithDefaults(ChainId.DFK_MAINNET, 'CRYSTAL/AVAX'),
      active: true
    },
    {
      pid: 2,
      tokens: getPairTokensWithDefaults(ChainId.DFK_MAINNET, 'CRYSTAL/WJEWEL'),
      active: true
    },
    {
      pid: 3,
      tokens: getPairTokensWithDefaults(ChainId.DFK_MAINNET, 'CRYSTAL/USDC'),
      active: true
    }
  ],
  [ChainId.DFK_TESTNET]: [
    {
      pid: 0,
      tokens: getPairTokensWithDefaults(ChainId.DFK_TESTNET, 'XJEWEL/WJEWEL'),
      active: true
    }
  ]
}
