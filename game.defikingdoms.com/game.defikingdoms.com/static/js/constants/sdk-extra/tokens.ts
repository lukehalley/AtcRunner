...
export const TOKENS: { [chainId in ChainId]: Tokens } = {
  ...
  [ChainId.DFK_MAINNET]: new Tokens(ChainId.DFK_MAINNET),
  [ChainId.DFK_TESTNET]: new Tokens(ChainId.DFK_TESTNET),
  [ChainId.HARMONY_MAINNET]: new Tokens(ChainId.HARMONY_MAINNET),
  [ChainId.HARMONY_TESTNET]: new Tokens(ChainId.HARMONY_TESTNET),
  [ChainId.AVALANCHE_C_CHAIN]: new Tokens(ChainId.AVALANCHE_C_CHAIN),
  [ChainId.AVALANCE_FUJI_TESTNET]: new Tokens(ChainId.AVALANCE_FUJI_TESTNET),
