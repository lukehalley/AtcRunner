import { ChainId, Currency, ETHER, HARMONY, JEWEL, BINANCE_COIN } from 'constants/sdk-extra'
  ...
  setBlockchain(blockchain?: Blockchain) {
    if (blockchain) {
      ...
      switch (this.chainId) {
        ...
        case 53935:
        case 335:
          this.blockchain = Blockchain.DFK_CHAIN
          break
        case 1666600000:
        case 1666700000:
        case 31337:
    ...
    if (name) {
      ...
      switch (this.chainId) {
        ...
        case 97:
          ...
          break
        case 53935:
          this.name = 'DFK Chain Mainnet'
          break
        case 335:
          this.name = 'DFK Chain Testnet'
          break
        case 1666600000:
    ...
    if (rpcURLs && rpcURLs.length > 0) {
      ...
      switch (this.chainId) {
        ...
        case 97:
          ...
          break
        case 53935:
          this.rpcURLs = ['https://subnets.avax.network/defi-kingdoms/dfk-chain/rpc']
          break
        case 335:
          this.rpcURLs = ['https://subnets.avax.network/defi-kingdoms/dfk-chain-testnet/rpc']
          break
        case 1666600000:
    ...
    if (explorerURL && explorerURL !== '') {
      ...
      switch (this.chainId) {
        ...
        case 97:
          ...
          break
        case 53935:
          this.explorerURL = 'https://subnets.avax.network/defi-kingdoms/dfk-chain/explorer'
          break
        case 335:
          this.explorerURL = 'https://explorer-test.dfkchain.com/'
          break
        case 1666600000:
...
export const BLOCKCHAIN_SETTINGS: { [chainId in ChainId]: BlockchainSettings } = {
  ...
  [ChainId.AVALANCHE_C_CHAIN]: new BlockchainSettings(ChainId.AVALANCHE_C_CHAIN),
  [ChainId.AVALANCE_FUJI_TESTNET]: new BlockchainSettings(ChainId.AVALANCE_FUJI_TESTNET),
  [ChainId.DFK_MAINNET]: new BlockchainSettings(ChainId.DFK_MAINNET),
  [ChainId.DFK_TESTNET]: new BlockchainSettings(ChainId.DFK_TESTNET),
