...
export const INVERTED_CHAIN_ID_MAP = Object.fromEntries(Object.entries(ChainId).map(([k, v]) => [v, k]))
...
export const CHAIN_RPC = {
  ...
  [ChainId.ETH]: 'https://eth-mainnet.alchemyapi.io/v2/2KGc5anzcDyuKCRT3EXPd7QanER_vvJq', // 'https://eth-mainnet.alchemyapi.io/v2/0AovFRYl9L7l4YUf6nPaMrs7H2_pj_Pf',
  [ChainId.OPTIMISM]: 'https://mainnet.optimism.io',
  [ChainId.BSC]: 'https://bsc-dataseed.binance.org/', // this will prob backfire but hey 'https://bsc-dataseed.binance.org/',
...
export const CHAIN_EXPLORER_URLS = {
  [ChainId.DFK]: 'https://subnets.avax.network/defi-kingdoms/dfk-chain/explorer',
  ...
  [ChainId.TERRA]: 'https://finder.terra.money/mainnet'
}
...
export const CHAIN_PARAMS = {
  [ChainId.DFK]: {
    ...
    rpcUrls: [WRITE_CHAIN_RPC[ChainId.DFK]],
    blockExplorerUrls: [CHAIN_EXPLORER_URLS[ChainId.DFK]] // might need to add / after explorer url
  },
  [ChainId.ETH]: {
