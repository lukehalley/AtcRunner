...
import eternalStoryPageImage from './images/eternal-story-page-10.png'

export const eternalStoryPageTen = new Item({
  key: ItemKeys.ETERNAL_STORY_PAGE_TEN,
  name: 'Eternal Story Page Ten',
  description:
