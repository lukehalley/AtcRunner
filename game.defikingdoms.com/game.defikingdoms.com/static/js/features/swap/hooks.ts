...
import { useV1Trade } from 'utils/data/V1'
...
const BAD_RECIPIENT_ADDRESSES: string[] = [
  ...
  '0x794C07912474351b3134E6D6B3B7b3b4A07cbAAa', // v2 factory DFK Chain Mainnet
  '0x2c22Ee594Fe562f548c88ed504D57Ebc86f1D9D1', // v2 factory DFK Chain Testnet
...
export function useDerivedSwapInfo(): {
  ...
  if (balanceIn && amountIn && balanceIn.lessThan(amountIn)) {
    const amountInCurrency = getBlockchainAdjustedCurrency(blockchain, amountIn?.currency, chainId)
...
function parseCurrencyFromURLParameter(urlParam: any, chainId: ChainId): string {
  ...
  if (typeof urlParam === 'string') {
    ...
    if (urlParam.toUpperCase() === baseCurrency.symbol) return baseCurrency.symbol as string
    if (valid === false) return baseCurrency.symbol as string
  }
