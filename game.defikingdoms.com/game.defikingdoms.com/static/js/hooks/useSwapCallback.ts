...
import { JSBI, Percent, Router, SwapParameters, Trade, TradeType } from 'constants/sdk-extra'
import { useTransactionAdder } from 'features/transactions/hooks'
import { calculateGasMargin, getRouterContract, isAddress, setGasProperty, shortenAddress } from 'utils'
import { getTradeVersion, useV1TradeExchangeAddress } from 'utils/data/V1'
      ...
      callback: async function onSwap(): Promise<string> {
        ...
        return contract[methodName](...args, {
          ...
          .then((response: any) => {
            ...
            const adjustedInputCurrency = getBlockchainAdjustedCurrency(blockchain, trade.inputAmount.currency, chainId)
