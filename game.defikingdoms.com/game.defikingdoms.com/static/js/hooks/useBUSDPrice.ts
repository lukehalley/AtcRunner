...
import { ChainId, Currency, currencyEquals, JSBI, Token, Price, WETH } from 'constants/sdk-extra'
...
export default function useBUSDPrice(currency?: Currency): Price | undefined {
  ...
  const busdTicker = isDFKChainHook(chainId) ? 'USDC' : chainId !== ChainId.HARMONY_TESTNET ? 'BUSD' : '1BUSD'
