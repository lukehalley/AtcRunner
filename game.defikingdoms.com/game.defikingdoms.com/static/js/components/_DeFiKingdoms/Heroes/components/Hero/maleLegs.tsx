...
const LeftLegMale = ({ legTop, legTopHighlight, legTopShadow, stroke }: any) => (
  <>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -0.5 30 45" shapeRendering="crispEdges" className={styles.color}>
      <path stroke={stroke} d="M17 31h3M16 32h5M15 33h6M15 34h6M15 35h6M15 36h6M16 37h5" />
    </svg>
  </>
)

const RightLegMale = ({ legTop, legTopHighlight, legTopShadow, stroke }: any) => (
  <>
    <img src={legTop} className={styles.clothing} />
    <img src={legTopHighlight} className={styles.highlight} />
    <img src={legTopShadow} className={styles.shadow} />
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -0.5 30 45" shapeRendering="crispEdges" className={styles.color}>
      <path stroke={stroke} d="M10 32h4M10 33h5M10 34h5M10 35h5M10 36h5M10 37h5" />
    </svg>
  </>
)

const LeftLegBtmMale = ({ legBottom, legBottomHighlight, legBottomShadow, stroke }: any) => (
  <>
...
const RightLegBtmMale = ({ legBottom, legBottomHighlight, legBottomShadow, stroke }: any) => (
  <>
    <img src={legBottom} className={styles.clothing} />
    <img src={legBottomHighlight} className={styles.highlight} />
    <img src={legBottomShadow} className={styles.shadow} />
