...
const HeroInfo = ({ hero }: HeroInfoProps) => {
  ...
  const summonPercentage =
    hero.generation == 0 ? 100 : hero.maxSummons == 0 ? 0 : ((hero.maxSummons - hero.summons) / hero.maxSummons) * 100
      ...
      <div className={styles.heroStats}>
        <div className={styles.heroFrame}>
          <div className={`${styles.statSummons} ${styles.row}`}>
            ...
            <div className={styles.bar}>
              <div
                ...
                style={{ width: (summonPercentage <= 100 ? summonPercentage : 100) + '%' }}
              ></div>
            </div>
              ...
              <div className={`${styles.statStamina} ${styles.row}`}>
                ...
                <div className={styles.bar}>
                  <div
                    ...
                    style={{ width: (staminaPercentage <= 100 ? staminaPercentage : 100) + '%' }}
                  >
                    {staminaPercentage < 100 && <div className={styles.staminaLoading} />}
                  </div>
                </div>
          ...
          <div className={`${styles.statXp} ${styles.row}`}>
            XP
            <div className={styles.bar}>
              <div className={styles.xpBar} style={{ width: xpPercentage <= 100 ? xpPercentage + '%' : 100 + '%' }} />
            </div>
