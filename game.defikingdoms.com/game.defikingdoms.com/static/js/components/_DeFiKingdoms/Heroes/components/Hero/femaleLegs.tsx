...
const LeftLegFemale = ({ legTop, legTopHighlight, legTopShadow, stroke }: any) => (
  <>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -0.5 30 45" shapeRendering="crispEdges" className={styles.color}>
      <path stroke={stroke} d="M16 29h2M14 30h5M13 31h6M13 32h6M13 33h7M14 34h6M15 35h5M15 36h5M16 37h4" />
    </svg>
  </>
)

const RightLegFemale = ({ legTop, legTopHighlight, legTopShadow, stroke }: any) => (
  <>
    <img src={legTop} className={styles.clothing} />
    <img src={legTopHighlight} className={styles.highlight} />
    <img src={legTopShadow} className={styles.shadow} />
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -0.5 30 45" shapeRendering="crispEdges" className={styles.color}>
      <path stroke={stroke} d="M10 30h4M9 31h5M9 32h5M9 33h5M9 34h5M9 35h5M10 36h4M10 37h4" />
    </svg>
  </>
)

const LeftLegBtmFemale = ({ legBottom, legBottomHighlight, legBottomShadow, stroke }: any) => (
  <>
...
const RightLegBtmFemale = ({ legBottom, legBottomHighlight, legBottomShadow, stroke }: any) => (
  <>
    <img src={legBottom} className={styles.clothing} />
    <img src={legBottomHighlight} className={styles.highlight} />
    <img src={legBottomShadow} className={styles.shadow} />
