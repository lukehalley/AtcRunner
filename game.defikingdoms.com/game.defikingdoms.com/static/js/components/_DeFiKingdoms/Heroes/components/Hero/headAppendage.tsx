...
import { ReactComponent as base8 } from 'assets/images/hero/head-appendage/head-appendage-base8.svg'
import { ReactComponent as base9 } from 'assets/images/hero/head-appendage/head-appendage-base9.svg'
...
import { ReactComponent as base20 } from 'assets/images/hero/head-appendage/head-appendage-base20.svg'
...
const getInfo = (mainClass: any): GetInfoProps => {
  switch (mainClass) {
    ...
    case 8: {
      return {
        base: base8,
        baseString: 'M21 3h1M25 3h1M20 4h2M25 4h2M20 5h2M25 5h2M19 6h3M25 6h3M18 7h3M25 7h3M18 8h2M26 8h2M18 9h2M26 9h2M18 10h3M25 10h3M19 11h3M24 11h3M20 12h2M24 12h2M20 13h2M24 13h2',
        overlay: overlay8
      }
    }
    case 9: {
    ...
    case 20: {
      return {
        base: base20,
        baseString: 'M23 5h1M19 6h1M23 6h1M27 6h1M19 7h2M22 7h3M26 7h2M20 8h7M19 9h9M18 10h2M21 10h2M24 10h2M27 10h2M18 11h5M24 11h5M18 12h1M20 12h1M26 12h1M28 12h1M15 13h4M28 13h4M18 14h1M28 14h1M18 15h1M28 15h1M16 16h2M19 16h1M27 16h1M29 16h2M19 17h1M27 17h1',
        overlay: overlay20
      }
    }
    case 24: {
...
export const HeadAppendage = ({ headId, stroke }: any) => {
  ...
  return (
    <>
      <Appendage base={info.base} baseString={info.baseString} overlay={info.overlay} stroke={stroke} />
    </>
  )
}
