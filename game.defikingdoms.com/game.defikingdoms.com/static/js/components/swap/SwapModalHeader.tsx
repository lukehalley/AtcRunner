  ...
  return (
    <AutoColumn gap={'md'} style={{ marginTop: '20px' }}>
      <RowBetween align="flex-end">
        ...
        <RowFixed gap={'0px'}>
          <Text fontSize={17} fontWeight={500} style={{ marginLeft: '10px' }}>
      ...
      {showAcceptChanges ? (
        <SwapShowAcceptChanges justify="flex-start" gap={'0px'}>
          <RowBetween>
            ...
            <Button
              style={{ padding: '.5rem', fontSize: '0.825rem', borderRadius: '12px' }}
      ...
      <AutoColumn justify="flex-start" gap="sm" style={{ padding: '12px 0 0 0px' }}>
        {trade.tradeType === TradeType.EXACT_INPUT ? (
          <TYPE.italic textAlign="left" style={{ width: '100%', fontSize: '18px' }}>
