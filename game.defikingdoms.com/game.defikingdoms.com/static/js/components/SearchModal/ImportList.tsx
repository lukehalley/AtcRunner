...
import { removeList, enableList } from 'features/lists/actions'
import { useAllLists } from 'features/lists/hooks'
        ...
        <AutoColumn gap="md">
          ...
          <Card style={{ backgroundColor: transparentize(0.8, theme.red1) }}>
            <AutoColumn justify="center" style={{ textAlign: 'center', gap: '16px', marginBottom: '12px' }}>
              <AlertTriangle stroke={theme.red1} size={16} />
              <TYPE.body fontWeight={500} fontSize={16} color={theme.red1}>
          ...
          <Button onClick={handleAddList} style={{ padding: '10px 1rem' }} disabled={!confirmed}>
            Import
          </Button>
          {addError ? (
