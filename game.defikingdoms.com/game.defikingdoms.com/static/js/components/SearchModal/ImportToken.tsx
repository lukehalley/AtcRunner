...
import { Token, Currency } from 'constants/sdk-extra'
import { useCombinedInactiveList } from 'features/lists/hooks'
import { useAddUserToken } from 'features/user/hooks'
      ...
      <PaddedColumn gap="md">
        ...
        >
          <AutoColumn justify="center" style={{ textAlign: 'center', gap: '16px', marginBottom: '12px' }}>
            <AlertTriangle stroke={fromLists ? theme.yellow2 : theme.red1} size={16} />
            <TYPE.body fontWeight={600} fontSize={16} color={fromLists ? theme.yellow2 : theme.red1}>
